...
async function sendAnalysis(data) {
  try {
    ...
    const payload = {
      ...
      textToHtml: data.textToHtml,
      aboveFold: data.aboveFold,
      hreflang: data.hreflang,
      schemaValidation: data.schemaValidation,
      lazyImages: data.lazyImages,
      mixedContent: data.mixedContent,
      iframes: data.iframes,
      socialCards: data.socialCards,
      faviconAndFeeds: data.faviconAndFeeds,
      mediaTypes: data.mediaTypes,
      keywordDensity: data.keywordDensity,
      tocNavigation: data.tocNavigation,
